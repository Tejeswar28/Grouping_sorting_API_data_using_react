...
function Selectoption1() {
  ...
  const handleCriteriaChange = (value) => {
    ...
    localStorage.setItem("selectedCriteria", value);
  };
  ...
  return (
    <div className="maini">
      <button className="disp" onClick={toggleBoxVisibility}>
        <b>-_: </b>Display <b className="arrow">v</b>
      </button>
      {isBoxVisible && (
